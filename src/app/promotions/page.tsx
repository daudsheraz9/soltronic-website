...
export default function PromotionsPage() {
  const smallPromos = [
    {
      title: "UNBEATABLE PACKAGE - Solis + Pylontech",
      image: "/unbeatable-package-v2.png"
    },
    {
      title: "COMMERCIAL STORAGE PACKAGE",
      image: "/pylontech-storage.png"
    },
    {
  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-8 md:pt-5 pb-10 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Hero Promotion */}
        <div className="mb-12">
          <h2 className="text-sm md:text-base font-bold text-[#1A4D2E] mb-4">Special Epic Sale</h2>

          <div className="w-full rounded-2xl overflow-hidden relative shadow-md">
            <Image
              src="/promotion-page-main-bannerv3.png"
