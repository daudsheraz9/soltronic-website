...
const productsData = [
  ...
  },
  {
    ...
    efficiency: "Type 2",
    warranty: "3 Yrs",
    labels: ["Power", "Connector", "Warranty"],
...
export default function Products() {
  ...
  const page2Data = [...productsData.slice(4), ...productsData.slice(0, 4)];
  const page3Data = [...productsData.slice(8), ...productsData.slice(0, 8)];
  const allProducts = [
    ...productsData, ...page2Data, ...page3Data, 
    ...productsData, ...page2Data, ...page3Data, 
    ...productsData, ...page2Data
  ];
              ...
              <div className="mt-10 flex justify-center">
                <nav className="inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                  <button 
                    ...
                    className="relative inline-flex items-center px-3 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button 
                    ...
                    className="relative inline-flex items-center px-3 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
